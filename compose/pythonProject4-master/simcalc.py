...
def sim_calc(my_song):
    #cursor.execute("SELECT spotify_id, acousticness, danceability, energy, instrumentalness, liveness, loudness, speechiness, valence, tempo FROM spotify_songs")
    ...
    #my_song = np.array([0.5 for _ in range(9)]).reshape(1, -1)
