...
# X = merged_df[feature_columns]  # Replace feature_columns with your actual list of feature column names
# y = merged_df[target_columns]   # Replace target_columns with your actual list of target column names
