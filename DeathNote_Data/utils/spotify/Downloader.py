...
import joblib
import configparser
from DeathNote_Data.orm.entities.SpotifyMusic import *
import spotipy
...
# Create a "songs" file directory conditionally
...
for keyword in keywords:
    ...
    for playlist in playlists:
        ...
        for track in tracks:
            ...
            if existing_song := findSpotifySong(spotify_id):
                ...
                if audio_features := get_spotify_audio_features(spotify_id):
